...
import Dhairya from "../assets/Ajay.png";
...
const Contact = () => {
  return (
    <>
      ...
      >
        <div className="bg-gradient-to-tl from-[#e1e1e1] to-[#fff] dark:from-[#111827] dark:to-[#111827] dark:shadow-none rounded-2xl shadow-xl WRAPPER flex justify-between p-7 mb-7 max-sm:flex-col-reverse max-sm:p-2 container mx-auto">
          <div className="ABOUT p-7">
            ...
            <div className="SOCIALS text-[#00040f] dark:text-white text-2xl flex gap-7 mt-5 max-sm:justify-evenly">
              {/* <a
                ...
                className=" hover:text-[#ccc]  dark:hover:text-sky-300"
              >
                <SiGithub />
              </a> */}
              <a
                href="https://www.linkedin.com/in/ajay-patil-8b9195186"
                className=" hover:text-[#ccc]  dark:hover:text-sky-300"
              >
                <SiLinkedin />
              </a>
              ...
              <a
                href="mailto:ajay1998patil999@gmail.com"
                className="hover:text-[#ccc] dark:hover:text-sky-300"
              >
                <SiGmail />
              </a>
        ...
        <p className="text-[#00040f] dark:text-slate-300 mx-2 text-center capitalize tracking-widest max-sm:text-sm p-2">
          made with 💙 by Ajay Patil & the Open Source Community
        </p>
      </section>
    </>
  );
