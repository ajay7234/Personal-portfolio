...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR container mx-auto lg:mt-8 mt-4 px-4 font-['Poppins'] max-sm:p-2 max-sm:max-h-[48px]">
        <div className="NAVBAR flex  justify-between capitalize">
          ...
          <div className="NAVLINKS text-[20px] lg:flex hidden gap-12 text-[#00040f] dark:text-[#e1e1e1] ">
            ...
            <button onClick={() => setNav(!nav)} className="lg:hidden block">
